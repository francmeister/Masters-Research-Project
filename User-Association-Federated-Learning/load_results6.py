...
axis[0,0].plot(timesteps_average_reward_in_memory_AP_1, average_reward_in_memory_AP_1)
#axis[1,0].plot(timesteps, energies)
axis[0,0].set_title('Average Utility Value in Training Memory AP 1')
axis[0,0].set_xlabel('Epoch')
axis[0,0].set_ylabel('Average Utility Value (bits/s)')
axis[0,0].grid()

axis[1,0].plot(timesteps_average_reward_in_memory_AP_2, average_reward_in_memory_AP_2)
#axis[1,0].plot(timesteps, energies)
axis[1,0].set_title('Average Utility Value in Training Memory AP 2')
axis[1,0].set_xlabel('Epoch')
axis[1,0].set_ylabel('Average Utility Value (bits/s)')
axis[1,0].grid()

axis[2,0].plot(timesteps_average_reward_in_memory_AP_3, average_reward_in_memory_AP_3)
#axis[1,0].plot(timesteps, energies)
axis[2,0].set_title('Average Utility Value in Training Memory AP 3')
axis[2,0].set_xlabel('Epoch')
axis[2,0].set_ylabel('Average Utility Value (bits/s)')
axis[2,0].grid()

axis[0,1].plot(timestep_DNN_training_loss_AP_1[window_size-1:], DNN_training_loss_AP_1_smooth)
#axis[0,1].plot(timesteps, throughputs)
axis[0,1].set_title('DNN Training Loss AP 1')
axis[0,1].set_xlabel('Training step')
axis[0,1].set_ylabel('Training Loss')
axis[0,1].grid()

axis[1,1].plot(timestep_DNN_training_loss_AP_2[window_size-1:], DNN_training_loss_AP_2_smooth)
#axis20,1].plot(timesteps, throughputs)
axis[1,1].set_title('DNN Training Loss AP 2')
axis[1,1].set_xlabel('Training step')
axis[1,1].set_ylabel('Training Loss')
axis[1,1].grid()

axis[2,1].plot(timestep_DNN_training_loss_AP_3[window_size-1:], DNN_training_loss_AP_3_smooth)
#axis[0,1].plot(timesteps, throughputs)
axis[2,1].set_title('DNN Training Loss AP 3')
