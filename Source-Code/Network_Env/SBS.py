...
class SBS():
    ...
    def calculate_achieved_system_reward(self, eMBB_Users, URLLC_Users):
        ...
        for eMBB_User in eMBB_Users:
            ...
            individual_reward = eMBB_User_channel_rate#eMBB_User_channel_rate#eMBB_User_energy_consumption #+ eMBB_User_channel_rate + eMBB_User_QOS_requirement_revenue_or_penelaty
