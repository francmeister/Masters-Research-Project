...
axis[0,0].set_title('URLLC Relaibility Constraint Reward')
axis[0,0].grid()

axis[0,1].plot(timesteps[window_size-1:], urllc_total_rate_smooth)
#axis[0,0].plot(timesteps, overall_users_reward)
axis[0,1].set_xlabel('Timestep')
axis[0,1].set_ylabel('Data rate (bits/slot)')
axis[0,1].set_title('URLLC Users Total Rate')
axis[0,1].grid()

axis[1,0].plot(timesteps[window_size-1:], F_L_inverse_smooth)
#axis[1,0].plot(timesteps, energies)
axis[1,0].set_title('F_L_inverse')
axis[1,0].set_xlabel('Timestep')
axis[1,0].set_ylabel('F_L_inverse')
axis[1,0].grid()

axis[1,1].plot(timesteps[window_size-1:], outage_probabilities_smooth)
#axis[1,0].plot(timesteps, energies)
