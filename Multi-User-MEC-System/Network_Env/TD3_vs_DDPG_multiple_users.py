...
timesteps_3_users = rewards_throughput_energy[:,0]
...
plt.plot(timesteps_3_users[window_size-1:], overall_users_reward_TD3_3_users_smooth, color="green", label="TD3")
plt.plot(timesteps_3_users[window_size-1:], overall_users_reward_TD3_7_users_smooth, color="blue", label="TD3")
plt.plot(timesteps_3_users[window_size-1:], overall_users_reward_TD3_11_users_smooth, color="red", label="TD3")

plt.plot(timesteps_3_users[window_size-1:], overall_users_reward_DDPG_3_users_smooth, color="brown", label='DDPG')
plt.plot(timesteps_3_users[window_size-1:], overall_users_reward_DDPG_7_users_smooth, color="yellow", label='DDPG')
plt.plot(timesteps_3_users[window_size-1:], overall_users_reward_DDPG_11_users_smooth, color="pink", label='DDPG')
...
plt.legend(["3 users TD3","7 users TD3","11 users TD3","3 users DDPG","7 users DDPG","11 users DDPG"], loc="upper left")
plt.grid()
