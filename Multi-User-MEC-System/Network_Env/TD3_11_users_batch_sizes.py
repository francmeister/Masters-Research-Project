...
rewards_throughput_energy_30_batch = np.load('timestep_rewards_energy_throughput_30_batch.npy')
rewards_throughput_energy_60_batch = np.load('timestep_rewards_energy_throughput_60_batch.npy')
rewards_throughput_energy_100_batch = np.load('timestep_rewards_energy_throughput_100_batch.npy')
...
overall_users_reward_30_batch = np.load('overall_users_reward_30_batch.npy')
overall_users_reward_60_batch = np.load('overall_users_reward_60_batch.npy')
overall_users_reward_100_batch = np.load('overall_users_reward_100_batch.npy')
#overall_users_reward_256_steps = np.load('overall_users_reward_TD3_256_steps.npy')

energy_rewards_30_batch = rewards_throughput_energy_30_batch[:,2]
energy_rewards_60_batch = rewards_throughput_energy_60_batch[:,2]
energy_rewards_100_batch = rewards_throughput_energy_100_batch[:,2]
#energy_rewards_256_steps = rewards_throughput_energy_256_steps[:,2]

throughput_rewards_30_batch = rewards_throughput_energy_30_batch[:,3]
throughput_rewards_60_batch = rewards_throughput_energy_60_batch[:,3]
throughput_rewards_100_batch = rewards_throughput_energy_100_batch[:,3]
#throughput_rewards_256_steps = rewards_throughput_energy_256_steps[:,3]

delay_rewards_30_batch = rewards_throughput_energy_30_batch[:,4]
delay_rewards_60_batch = rewards_throughput_energy_60_batch[:,4]
delay_rewards_100_batch = rewards_throughput_energy_100_batch[:,4]
...
timesteps_30_batch = rewards_throughput_energy_30_batch[:,0]
timesteps_60_batch = rewards_throughput_energy_60_batch[:,0]
timesteps_100_batch = rewards_throughput_energy_100_batch[:,0]
...
overall_users_reward_30_batch_smooth = moving_average(overall_users_reward_30_batch, window_size)
overall_users_reward_60_batch_smooth = moving_average(overall_users_reward_60_batch, window_size)
overall_users_reward_100_batch_smooth = moving_average(overall_users_reward_100_batch, window_size)
#overall_users_reward_30_batch_smooth = moving_average(overall_users_reward_256_steps, window_size)

energy_rewards_30_batch_smooth = moving_average(energy_rewards_30_batch, window_size)
energy_rewards_60_batch_smooth = moving_average(energy_rewards_60_batch, window_size)
energy_rewards_100_batch_smooth = moving_average(energy_rewards_100_batch, window_size)
#energy_rewards_256_steps_smooth = moving_average(energy_rewards_256_steps, window_size)

throughput_rewards_30_batch_smooth = moving_average(throughput_rewards_30_batch, window_size)
throughput_rewards_60_batch_smooth = moving_average(throughput_rewards_60_batch, window_size)
throughput_rewards_100_batch_smooth = moving_average(throughput_rewards_100_batch, window_size)
#throughput_rewards_256_steps_smooth = moving_average(throughput_rewards_256_steps, window_size)

delay_rewards_30_batch_smooth = moving_average(delay_rewards_30_batch, window_size)
delay_rewards_60_batch_smooth = moving_average(delay_rewards_60_batch, window_size)
delay_rewards_100_batch_smooth = moving_average(delay_rewards_100_batch, window_size)
