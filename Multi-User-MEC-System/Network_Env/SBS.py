...
class SBS():
    ...
    def calculate_achieved_system_reward(self, eMBB_Users, urllc_users, communication_channel, q_action):
        ...
        if self.energy_rewards > 0:
            self.energy_efficiency_rewards = (q_throughput*total_users_throughput_reward)/(q_energy*total_users_energy_reward)#/self.throughput_rewards/self.energy_rewards
        else:
            self.energy_efficiency_rewards = 0
