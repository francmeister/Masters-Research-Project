...
total_offload_queueing_violation_prob_reward = np.load('total_offload_queueing_violation_prob_reward.npy')
total_offload_ratio_reward = np.load('total_offload_ratio_reward.npy')
total_local_traffic_reward = np.load('total_local_traffic_reward.npy')
...
total_local_traffic_reward_smooth = moving_average(total_local_traffic_reward,window_size)
total_offload_queueing_violation_prob_reward_smooth = moving_average(total_offload_queueing_violation_prob_reward,window_size)
...
axis[0,3].plot(timesteps[window_size-1:], total_local_queueing_violation_prob_reward_smooth)
axis[0,3].set_title('Local Queueing Violation Probability Reward')
axis[0,3].set_xlabel('Timestep')
#axis[3,0].set_ylabel('Constraint Value')
axis[0,3].grid()

axis[1,3].plot(timesteps[window_size-1:], total_local_traffic_reward_smooth)
axis[1,3].set_title('Local Traffic Constraint Sum Reward')
axis[1,3].set_xlabel('Timestep')
#axis[3,0].set_ylabel('Constraint Value')
axis[1,3].grid()

axis[2,3].plot(timesteps[window_size-1:], total_offload_queueing_violation_prob_reward_smooth)
axis[2,3].set_title('Offload Queueing Violation Probability Reward')
