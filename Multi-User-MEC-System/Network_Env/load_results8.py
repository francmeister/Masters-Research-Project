...
urllc_total_rate_per_second = np.load('urllc_total_rate_per_second.npy')
urllc_total_rate_per_slot = np.load('urllc_total_rate_per_slot.npy')
...
urllc_total_rate_per_second_smooth = moving_average(urllc_total_rate_per_second,window_size)
urllc_total_rate_per_slot_smooth = moving_average(urllc_total_rate_per_slot,window_size)
...
axis[0,0].set_title('URLLC Reliability Reward')
axis[0,0].grid()
...
axis[0,1].plot(timesteps[window_size-1:], urllc_total_rate_per_second_smooth)
#axis[0,1].plot(timesteps, throughputs)
axis[0,1].set_title('URLLC Total Rate')
axis[0,1].set_xlabel('Timestep')
axis[0,1].set_ylabel('Data Rate (bits/s)')
axis[0,1].grid()

axis[1,1].plot(timesteps[window_size-1:], urllc_total_rate_per_slot_smooth)
axis[1,1].set_title('URLLC Total Rate')
axis[1,1].set_xlabel('Timestep')
axis[1,1].set_ylabel('Data Rate (bits/slot)')
axis[1,1].grid()

axis[2,0].plot(timesteps[window_size-1:], F_L_inverse_smooth)
axis[2,0].set_title(r'$l_u^{(m)} \cdot [F_L^{-1} (1 - \epsilon_{\mathrm{max}}^{(m)})]$')
