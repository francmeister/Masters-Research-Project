...
# power_actions = np.load('power_actions.npy')
# RBs_actions = np.load('subcarrier_actions.npy')
string_reward_component = 'power_actions'
print('len(power_actions[0]): ',len(power_actions[0]))
individual_sub_plots(numbers_users=len(power_actions[0]),timesteps=timesteps,reward_component=power_actions,string_reward_component=string_reward_component)
